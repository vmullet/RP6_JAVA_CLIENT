				...
				if (_cb_trajectory_mode.getSelectedIndex() != -1) {
					if (_editorTrajectory.getCommandsListSize() > 0) {
						...
						if (returned == JFileChooser.APPROVE_OPTION) {
							...
							if (writtenPath != null)
								JOptionPane.showMessageDialog(null, "Le fichier " + writtenPath + " a été créé avec succès");
							else
					...
					JOptionPane.showMessageDialog(null, "Veuillez sélectionner un mode trajectoire valide");
				}
